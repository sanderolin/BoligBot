...
export const [i18nextMiddleware, getLocale, getInstance] =
    createI18nextMiddleware({
        detection: {
            supportedLanguages: ["en", "nb"], // Your supported languages, the fallback should be last
            fallbackLanguage: "nb", // Your fallback language
...
declare module "i18next" {
    interface CustomTypeOptions {
        ...
        resources: typeof resources.nb; // Use `nb` as source of truth for the types
    }
}
